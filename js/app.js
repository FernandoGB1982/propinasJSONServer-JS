...
function agregarPlatillo(producto) {
    ...
    if(producto.cantidad > 0){
        ...
        //Comprueba si el elemento ya esxiste en el array de pedido
...
function actualizarResumen() {
    ...
    pedido.forEach(articulo => {
        ...
        // Agregar valores dentro de sus contenedores
...
function mostrarTotalHTML(subtotal, propina, total) {
    ...
    subtotalSpan.classList.add('fs-4', 'fw-normal', 'mt-2');
    ...
    propinaSpan.classList.add('fs-4', 'fw-normal', 'mt-2');
    ...
    totalSpan.classList.add('fs-4', 'fw-normal', 'mt-2');
    ...
    const totalDivPagar = document.querySelector('.total-pagar');
    if(totalDivPagar) {
        totalDivPagar.remove();
    }
